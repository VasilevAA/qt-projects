...
public:
	...
	bool createNewGraphWithFormat(QString file_name); //создать форматированный граф из файла
...
public slots:
	void savePicture(); //сохранить как картинку
...
private slots:
	void showTextGraph(); //отобразить текстовое представление графа (список инцид.)
